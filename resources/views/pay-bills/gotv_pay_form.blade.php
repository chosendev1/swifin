        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="example-title">Pay GOtv</h4>
                  <p>
                    Fill form below to pay <code>GOtv bills</code> using <code>Swifin Money</code>
                  </p>
                  <div class="example">
                    <form class="form-horizontal" method="POST" action="/paybills/gotv">
                      {{ csrf_field() }}
                      <input type='hidden' name='tv_type' value='gotv'>
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">GOtv Account: </label>
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="customer_account" value="{{ old('customer_account') }}" placeholder="GOtv Account No." autocomplete="off"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
