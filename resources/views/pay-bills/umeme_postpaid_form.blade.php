        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="example-title">Pay Umeme (Postpaid)</h4>
                  <p>
                    Fill form below to pay Umeme bills using <code>Swifin Money</code>
                  </p>
                  <div class="example">
                    <form class="form-horizontal" method="POST" action="/paybills/umeme/postpaid">
                      {{ csrf_field() }}
                      <input type="hidden" name="umeme_bill_type" value="postpaid">
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">Umeme Account No: </label>
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="customer_account" value="{{ old('customer_account') }}" placeholder="Umeme Account No." autocomplete="off"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
