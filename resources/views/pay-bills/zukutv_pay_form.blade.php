        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="example-title">Pay ZUKUtv</h4>
                  <p>
                    Fill form below to pay <code>ZUKUtv bills</code> using <code>Swifin Money</code>
                  </p>
                  <div class="example">
                    <form class="form-horizontal" method="POST" action="/paybills/zukutv">
                      {{ csrf_field() }}
                      <input type='hidden' name='tv_type' value='zukutv'>
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">ZUKUtv Account: </label>
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="customer_account" value="{{ old('customer_account') }}" placeholder="ZUKUtv Account No." autocomplete="off"
                          />
                        </div>
                      </div>
                      <div class="form-group row">
